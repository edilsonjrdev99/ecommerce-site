...
// Emitir evento quando produto for clicado
const emit = defineEmits<{
  click: [product: MainProducts];
  buyClick: [product: MainProducts];
}>();
...
<template>
  <article class="product-card" @click="handleProductClick">
    <!-- Badge de desconto -->
    <div v-if="product.discountValue" class="product-card__discount-badge">
      {{ calculateDiscountPercentage(product.price, product.discountValue) }}%
      OFF
    </div>
      ...
      <div class="product-card__pricing">
        <div class="product-card__price-wrapper">
          ...
          <span class="product-card__price-current">
            R$
            {{ formatPrice(product.discountValue || product.price) }}
          </span>
        </div>
      </div>

      <!-- Botão de comprar -->
      <button class="product-card__buy-button" @click="handleBuyClick">
        <svg
